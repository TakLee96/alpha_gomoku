...
parser.add_argument('--ensemble1', '-e1', action='store_true')
parser.add_argument('--ensemble2', '-e2', action='store_true')
...
with a_sess.as_default():
    with a_graph.as_default():
        a_agent = Agent(a_sess, args.model_name_1, chkpnt=args.chkpnt1, ensemble=args.ensemble1)
with b_sess.as_default():
    with b_graph.as_default():
        b_agent = Agent(b_sess, args.model_name_2, chkpnt=args.chkpnt2, ensemble=args.ensemble2)
